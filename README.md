...
-> Being able to move around conveniently, use screen readers, etc
2. Talk about 3 different things you can do to ensure your website is accessible.
-> Use 'alt' part of <img> tag, make things clearly distiguishable/readable, and using breakpoints
3. How would you explain the concept of a variable to someone new to programming?
-> A convenient spot to store information
