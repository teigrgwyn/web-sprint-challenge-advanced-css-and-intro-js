...
artists[9].name = "Vincent Van Gogh"; // not sure how i'd use a method without a function, considering a simple propery reassignment works
...
function addArtist(array){
  array.push({id: 20, name: 'Cory Young', years: '1995 - 2020', genre: 'Web Design', nationality: 'American', bio: 'lorem ipsum'});
  return array;
}
...
function getHTML(data){
  ...
  // setup temp variables to hold semantic areas, then format strings so they indent properly?
}
...
function randomize(array){
  // apparently different shuffle ideas, and fisher-yates is the go-to
}


/* 💪💪💪💪💪💪 STRETCH 3: 💪💪💪💪💪💪
Use advanced array methods (.map, .reduce, .filer) to refactor your MVP code (create an array of all artists born in the 1900s with .filter, for example) */
// a good project for over the weekend; i know maps are critical knowledge to know
